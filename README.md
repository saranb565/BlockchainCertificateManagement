<<<<<<< HEAD
<<<<<<< HEAD
# BlockchainCertificateManagement
A decentralized application (dApp) for secure and tamper-proof certificate validation using Ethereum blockchain. This project ensures that certificates issued by institutions are immutable, verifiable, and easily accessible.
=======
